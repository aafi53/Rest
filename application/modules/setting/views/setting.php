        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <?php echo form_open_multipart('setting/setting/create','class="form-inner"') ?>
                    ...
                    <div class="form-group row">
                        <label for="storevat" class="col-xs-3 col-form-label"><?php echo display('vat_type') ?></label>
                        <div class="col-xs-9">
                            <select class="form-control" name="vat_type">
                            	<option value=""><?php echo display('vat_type') ?></option>
                                <option value="inclusive" <?php if($setting->vat_type=="inclusive"){ echo "selected";}?>><?php echo display('inclusive') ?></option>
                                <option value="exclusive" <?php if($setting->vat_type=="exclusive"){ echo "selected";}?>><?php echo display('exclusive') ?></option>
                            </select>
                        </div>
                    </div>
					<div class="form-group row">
