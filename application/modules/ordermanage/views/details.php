                ...
                <div class="panel-footer text-right">
	                ...
	                <div id="printableArea">
	                    <div class="panel-body">
	                        <div class="row">
	                            <div class="col-sm-4  display-inlineblock">
								...
								<div class="col-sm-4  mb-display!`">
								<?php

                          $date = new DateTime($orderinfo->order_date);
                           $inv_date=$date->format('Y-m-d\TH:i:s\Z');
						  $qrtext = $this->inv_qrcode->base64([
							'seller'           => $storeinfo->storename,
							'vat_no'           => $storeinfo->vattinno,
							'date'             => $inv_date,
							'grand_total'      => $billinfo->bill_amount,
							'total_tax_amount' => $calvat,
						   ]); ?>
